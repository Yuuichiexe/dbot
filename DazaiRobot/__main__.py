...
def about_ai_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "ai_help":
        query.message.edit_text(
            text=f"""𝖠ʀᴛɪғɪᴄɪᴀʟ ɪɴᴛᴇʟʟɪɢᴇɴᴄᴇ ғᴇᴀᴛᴜʀᴇs [🤖](https://te.legra.ph/file/0a0b5c2432970e49f1038.jpg)
➖➖➖➖➖➖➖➖➖➖➖➖➖➖     
◎ /aigen : 𝖦𝖾𝗇𝖾𝗋𝖺𝗍𝖾𝗌 𝗉𝗂𝖼𝗍𝗎𝗋𝖾 𝖻𝖺𝗌𝖾𝖽 𝗈𝗇 
                  𝗀𝗂𝗏𝖾𝗇 𝗉𝗋𝗈𝗆𝗉𝗍.
                     
◎ /upscale : 𝗂𝗇𝖼𝗋𝖾𝖺𝗌𝖾 𝗊𝗎𝖺𝗅𝗂𝗍𝗒 𝗈𝖿 𝖺𝗇𝗒 
                   𝗉𝗂𝖼𝗍𝗎𝗋𝖾.
                       
◎ /rmbg : 𝖱𝖾𝗆𝗈𝗏𝖾𝗌 𝗂𝗆𝖺𝗀𝖾 𝖻𝖺𝖼𝗄𝗀𝗋𝗈𝗎𝗇𝖽

◎ /ask : 𝖥𝖺𝗌𝗍 𝖦𝖯𝖳4 𝖥𝗈𝗋 𝗋𝖾𝗌𝗉𝗈𝗇𝖽𝗂𝗇𝗀 𝗍𝗈 
               𝗎𝗌𝖾𝗋 𝗊𝗎𝖾𝗋𝗂𝖾𝗌.""",
             parse_mode=ParseMode.MARKDOWN,
             disable_web_page_preview=True,
             reply_markup=InlineKeyboardMarkup(
